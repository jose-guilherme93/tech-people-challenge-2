            ...
            <section className={styles.containerWrapper}>
                ...
                <section className={styles.gridContainer}>
                    <div className={styles.date}>
                        <img src={infoNews.image[0]} className={styles.imgBanner} alt="wer" />
                    ...
                    <div className={styles.date}>                        
                        <img src={infoNews.image[1]} className={styles.imgBanner} alt="calendário" />
                    ...
                    <div className={styles.date}>         
                        <img src={infoNews.image[2]} className={styles.imgBanner} alt="calendário" />
